...
QUEENSIDE_CASTLING_SQUARES = {WHITE: [58, 59], BLACK: [2, 3]}
QUEENSIDE_MUST_BE_EMPTY_SQUARES = {WHITE: [57, 58, 59], BLACK: [1, 2, 3]}
QUEENSIDE_CASTLING_ENDSQUARE = {WHITE: 58, BLACK: 2}
